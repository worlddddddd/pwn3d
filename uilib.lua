...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddBind({text = 'Open / Close', flag = 'togglebind', nomouse = true, noindicator = true, bind = Enum.KeyCode.RightAlt, callback = function()
    ...
    local v1 = mainSection:AddToggle({text = 'Keybind Indicator', flag = 'keybind_indicator', callback = function(bool)
    ...
    local v2 = mainSection:AddToggle({text = 'Enabled', flag = 'watermark_enabled'});
    v2:SetState(true)
    local v3 = mainSection:AddList({text = 'Position', flag = 'watermark_pos', selected = 'Custom', values = {'Top', 'Top Left', 'Top Right', 'Bottom Left', 'Bottom Right', 'Custom'}, callback = function(val)
